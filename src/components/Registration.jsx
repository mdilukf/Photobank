    ...
    <>
                ...
                <div className="Auth-form-content dispion">
                  ...
                  <div className="form-group mt-3">
                    {emailDirty && emaeiError && (
                      <div style={{ color: "red", background: "none",  paddingLeft: '4%' }}>
                        {emaeiError}
                      </div>
                    )}
      ...
      {tab == "feedbeck" && (
        <>
          <div className="Auth-form-container">
            <form className="Auth-form">
              <div className="Auth-form-content dispionA">
                ...
                <div className="form-group mt-3">
                  {passwordregDirty && passwordregError && (
                    <div style={{ color: "red", background: "none",  paddingLeft: '4%' }}>
                      {passwordregError}
                    </div>
                  )}
                  <label>Пароль</label>
                  <input
                    onChange={(e) => paswordregHendler(e)}
                    value={passwordreg}
                    onBlur={(e) => blurHandle(e)}
                    type="password"
                    className="form-control mt-1"
                ...
                {selectedForm == "fotograf" ? (
                  <>
                    ...
                    <label className="form-label input-foto5" for="customFile">
                      Соглашение о передаче исключительных прав, подробнее в разделе для авторов
                    </label>
                    <input
                      type="checkbox"
                      className="checkboxA"
                      id="customFile4"
                    />
                    <div className="d-grid gap-2 mt-3 positionA">
                      <button
                        disabled={!formValidTwo}
                        type="button"
                        className="btn btn-primary vchod"
                        onClick={test}
                      >
