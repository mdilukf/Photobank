    ...
    <HeaderComponent>
      <Navbar collapseOnSelect expand="lg" className="navbae">
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav" className="mini">
            ...
            <Nav className="d-flex gap-3" activeKey="/home">
              ...
              <Nav.Item>
                <Nav.Link eventKey="link-1" className="navigation">
              ...
              <Nav.Item>
                <Nav.Link eventKey="link-2 " style={{width: '87px'}} className="navigation">
